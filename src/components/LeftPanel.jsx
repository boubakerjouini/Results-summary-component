...
const LeftPanel = () => {
  return (
    <div className="flex flex-col bg-gradient-to-t from-background-dark to-background-light md:w-[500px] rounded-b-3xl sm:rounded-3xl px-[35px] py-8 align-middle items-center z-50 ">
